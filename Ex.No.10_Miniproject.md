...
### AIM: 
To develop a simple 2D game that updates player actions, detects collisions, and displays interactive gameplay on screen.
### Algorithm:
```
...
```
### Output:
<img width="1481" height="933" alt="512589588-2226f375-4622-4b76-b1ac-9e9a373bb160" src="https://github.com/user-attachments/assets/37b0fd2c-d78a-4c9c-9572-d89a8acb4a9a" />



### Result:
The 2D game was successfully implemented with smooth player controls and collision detection.
